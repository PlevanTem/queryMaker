...
9. Vary sentence count based on Query目标复杂度 from 20 ~ 300 words，参考下述三种specificity规格：
- vague: the user barely describes what they want; the system must infer a lot. 2-3 short sentences of context and broad goal — no trailing question, no sign-off.
...
<vague>
I'm trying to put together something where my team can track our weekly numbers without digging through spreadsheets. Nothing fancy, just clean and easy to read.
</vague>
